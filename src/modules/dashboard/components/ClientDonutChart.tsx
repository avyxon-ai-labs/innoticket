...
/**
 * Health overview donut for the CLIENT role.
 * Identical SVG donut rendering as the staff version, but with no
 * escalation slices and no escalation bars section.
 *
 * No role checks — role routing in DashboardPage.
 */
  ...
  return (
    <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[16px] p-4
      ...
      {isLoading ? (
        ...
        <>
          {/* ── Donut ── */}
          <div className="relative flex justify-center" onMouseLeave={clearTip}>
            <svg
              ref={svgRef}
            ...
            >
              ...
              <text
                ...
                style={{ fontSize: 21, fontWeight: 900, fill: 'var(--ink)', fontFamily: 'inherit' }}
              >
                {total.toLocaleString()}
              </text>
              <text
                x={CX} y={CY + 11} textAnchor="middle"
                style={{ fontSize: 7, fontWeight: 700, letterSpacing: '0.12em', fill: '#94A3B8', fontFamily: 'inherit' }}
              >
                TICKETS
              </text>
            </svg>
