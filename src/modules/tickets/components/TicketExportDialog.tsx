...
const ALL_COLS: ExportCol[] = [
  ...
  { key: 'activeDuration',   label: 'Active Duration',      getValue: (t) => formatActiveDuration(t.activeSince, t.activeEndedAt) || '' },
  ...
  { key: 'resolvedBy',       label: 'Resolved By',          getValue: (t) => t.resolvedBy || '' },
